...
class Graph:
    ...
    def _mark_branch(self, vertex_id: str, state: str, visited: set | None = None, output_name: str | None = None) -> None:
    ...
    def _record_snapshot(self, vertex_id: str | None = None, start: bool = False) -> None:
