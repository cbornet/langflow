...
class OpenTelemetry(metaclass=ThreadSafeSingletonMetaUsingWeakref):
    ...
    def _add_metric(self, name: str, description: str, unit: str, metric_type: MetricType, labels: dict[str, bool]) -> None:
    ...
    def __init__(self, prometheus_enabled: bool = True) -> None:
